...
filename = current_path+'/PreProcessing/raw_data/csv/WordFrequencies_data.csv'
print (filename) 
...
for vector_value, group_df in grouped:
    ...
    file_name = current_path+'/PreProcessing/results/local/'+f'data_{vector_value}.csv'
