...
sig_columns = ['filename','word','wordavg','percent_of_total','JSD','final_JSD','dt','period'] 
...
unique_periods = concat_df['period'].unique()

print(unique_periods)
print(unique_periods.shape)

for period  in unique_periods:
    filtered_df = concat_df[concat_df['period'] == period]
    ...
    condition = filtered_df['period'] ==  period
    ...
    #selected_columns_df=top_30_df['filename','word','wordavg','percent_of_total','JSD','wordCount_x','wordCount_y','final_JSD','dt','period']
...
sig_df.to_csv(current_path+'/Signatures/results/signatures_30_period.csv', index=True)  
